...
- **[Zabbix Custom Items](https://github.com/polar-n0de/zabbix-custom-items)** — Custom monitoring user parameters and items for Windows security and network device monitoring. Production-ready.
